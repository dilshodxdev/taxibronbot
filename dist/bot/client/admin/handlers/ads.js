...
exports.addRouteScene = exports.announcementScene = void 0;
...
// E'lon berish scene
exports.announcementScene = new telegraf_1.Scenes.WizardScene("ANNOUNCEMENT_SCENE", async (ctx) => {
    await ctx.reply("📢 E'lon matnini kiriting:");
    return ctx.wizard.next();
}, async (ctx) => {
...
async function sendAnnouncementToAllClients(ctx) {
    try {
        const announcementText = ctx.scene.session.announcementText;
        if (!announcementText) {
            await ctx.reply("❌ E'lon matni topilmadi.");
...
// Yo'l qo'shish scene
exports.addRouteScene = new telegraf_1.Scenes.WizardScene("ADD_ROUTE_SCENE", async (ctx) => {
    await ctx.reply("✏ Yo'nalishni kiriting (masalan: Toshkent - Samarqand):");
    return ctx.wizard.next();
}, async (ctx) => {
...
📍 <b>Buyurtma qilish:</b> <a href="https://t.me/TaxibronBot">@TaxibronBot</a>
    ...
    await ctx.reply(announcement, {
        ...
        ...telegraf_1.Markup.inlineKeyboard([
            [telegraf_1.Markup.button.callback("✅ Yuborish", "send_announcement")],
            [telegraf_1.Markup.button.callback("❌ Bekor qilish", "cancel_announcement")],
        ]),
    });
    return ctx.wizard.next();
}, 
